...
function(r) {
    ...
    var e = $.Base64,
        ...
        o = {
            hostname: function() {
                // return "gateway.aidaojia.com"
                var e = "gateway.aidaojia.com";
                return ((location.hostname == "www.aidaojia.com" || location.hostname == "aidaojia.com") && location.port == "") ? e = "gateway.aidaojia.com" : e = "test.gateway.aidaojia.com", e
            }(),
                                ...
                                if ((xhr.status >= 200 && xhr.status < 300) || xhr.status == 304) {
                                    ...
                                    try {
                                        ...
                                        var e = result.code,
                                            t = result.msg,
                                            o = result.data || {};
                                        200 == e ? n(o) : $message.error(t || '请求出错，请重试')
...
var kStorage = {
    ...
    r.lib = r.lib || {}, r.lib.ktop = a, r.lib.kStorage=kStorage
}(window);